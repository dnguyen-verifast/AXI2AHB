`ifndef X2H_VIRTUAL_BK_OKAY_RESPONSE_WRITE_READ_SEQ_INCLUDED_
`define X2H_VIRTUAL_BK_OKAY_RESPONSE_WRITE_READ_SEQ_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: x2h_virtual_bk_okay_response_write_read_seq
// Creates and starts the master and slave sequences
//--------------------------------------------------------------------------------------------
class x2h_virtual_bk_okay_response_write_read_seq extends x2h_virtual_base_seq;
  `uvm_object_utils(x2h_virtual_bk_okay_response_write_read_seq)
  ...
  //-------------------------------------------------------
  extern function new(string name = "x2h_virtual_bk_okay_response_write_read_seq");
  extern task body();
endclass : x2h_virtual_bk_okay_response_write_read_seq
...
//
// Parameters:
//  name - x2h_virtual_bk_okay_response_write_read_seq
//--------------------------------------------------------------------------------------------
function x2h_virtual_bk_okay_response_write_read_seq::new(string name = "x2h_virtual_bk_okay_response_write_read_seq");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
task x2h_virtual_bk_okay_response_write_read_seq::body();
