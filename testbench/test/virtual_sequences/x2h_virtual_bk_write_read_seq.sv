`ifndef X2H_VIRTUAL_BK_WRITE_READ_SEQ_INCLUDED_
`define X2H_VIRTUAL_BK_WRITE_READ_SEQ_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: x2h_virtual_bk_write_read_seq
// Creates and starts the master and slave sequences
//--------------------------------------------------------------------------------------------
class x2h_virtual_bk_write_read_seq extends x2h_virtual_base_seq;
  `uvm_object_utils(x2h_virtual_bk_write_read_seq)
  ...
  //-------------------------------------------------------
  extern function new(string name = "x2h_virtual_bk_write_read_seq");
  extern task body();
endclass : x2h_virtual_bk_write_read_seq
...
//
// Parameters:
//  name - x2h_virtual_bk_write_read_seq
//--------------------------------------------------------------------------------------------
function x2h_virtual_bk_write_read_seq::new(string name = "x2h_virtual_bk_write_read_seq");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
task x2h_virtual_bk_write_read_seq::body();
  ...
  `uvm_info(get_type_name(), $sformatf("DEBUG_MSHA :: Insdie x2h_virtual_bk_write_read_seq"), UVM_NONE); 

  fork 
      forever begin
        ahb_slave_bk_write_seq_h.start(p_sequencer.ahb_slave_sequencer_h);
      end
  join_none
