`ifndef X2H_VIRTUAL_NBK_WRAP_BURST_WRITE_READ_SEQ_INCLUDED_
`define X2H_VIRTUAL_NBK_WRAP_BURST_WRITE_READ_SEQ_INCLUDED_

//--------------------------------------------------------------------------------------------
// Class: x2h_virtual_nbk_wrap_burst_write_read_seq
// Creates and starts the master and slave sequences
//--------------------------------------------------------------------------------------------
class x2h_virtual_nbk_wrap_burst_write_read_seq extends x2h_virtual_base_seq;
  `uvm_object_utils(x2h_virtual_nbk_wrap_burst_write_read_seq)
  ...
  //Variable: ahb_slave_read_wrap_burst_seq_h
  //Instantiation of ahb_slave_read_wrap_burst_seq handle
  ahb_slave_nbk_read_wrap_burst_seq ahb_slave_nbk_read_wrap_burst_seq_h;

  //-------------------------------------------------------
  // Externally defined Tasks and Functions
  //-------------------------------------------------------
  extern function new(string name = "x2h_virtual_nbk_wrap_burst_write_read_seq");
  extern task body();
endclass : x2h_virtual_nbk_wrap_burst_write_read_seq
...
//
// Parameters:
//  name - x2h_virtual_nbk_wrap_burst_write_read_seq
//--------------------------------------------------------------------------------------------
function x2h_virtual_nbk_wrap_burst_write_read_seq::new(string name = "x2h_virtual_nbk_wrap_burst_write_read_seq");
  super.new(name);
endfunction : new
...
//--------------------------------------------------------------------------------------------
task x2h_virtual_nbk_wrap_burst_write_read_seq::body();
  ...
  ahb_slave_nbk_read_wrap_burst_seq_h = ahb_slave_nbk_read_wrap_burst_seq::type_id::create("ahb_slave_nbk_read_wrap_burst_seq_h");

  `uvm_info(get_type_name(), $sformatf("DEBUG_MSHA :: Insdie x2h_virtual_nbk_wrap_burst_write_read_seq"), UVM_NONE); 
  ...
  fork 
    ...
    begin : T2_SL_RD
      forever begin
        ahb_slave_nbk_read_wrap_burst_seq_h.start(p_sequencer.ahb_slave_read_seqr_h);
      end
    end
  join_none
