...
function void x2h_base_test::build_phase(uvm_phase phase);
  ...
  x2h_env_config_h = x2h_env_config::type_id_create::("x2h_env_config_h",this);
...
function void x2h_base_test::setup_axi4_master_agent_cfg();
  ...
  bit [63:0]local_max_address;
    axi4_env_cfg_h.axi4_master_agent_cfg_h =
    axi4_master_agent_config::type_id::create($sformatf("axi4_master_agent_cfg_h"));
    axi4_env_cfg_h.axi4_master_agent_cfg_h.is_active   = uvm_active_passive_enum'(UVM_ACTIVE);
    axi4_env_cfg_h.axi4_master_agent_cfg_h.has_coverage = 1; 
    uvm_config_db#(axi4_master_agent_config)::set(this,"*",$sformatf("axi4_master_agent_config"),axi4_env_cfg_h.axi4_master_agent_cfg_h);

    if(i == 0) begin  
      axi4_env_cfg_h.axi4_master_agent_cfg_h.master_min_addr_range(i,0);
      local_min_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.master_min_addr_range_array;
      axi4_env_cfg_h.axi4_master_agent_cfg_h.master_max_addr_range(i,2**(SLAVE_MEMORY_SIZE)-1 );
      local_max_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.master_max_addr_range_array;
    end
    else begin
      axi4_env_cfg_h.axi4_master_agent_cfg_h.master_min_addr_range(i,local_max_address + SLAVE_MEMORY_GAP);
      local_min_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.master_min_addr_range_array;
      axi4_env_cfg_h.axi4_master_agent_cfg_h.master_max_addr_range(i,local_max_address+ 2**(SLAVE_MEMORY_SIZE)-1 + 
                                                                      SLAVE_MEMORY_GAP);
      local_max_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.master_max_addr_range_array;
    end
...
function void x2h_base_test::setup_axi4_slave_agent_cfg();
  ...
  foreach(axi4_env_cfg_h.axi4_slave_agent_cfg_h)begin
    axi4_env_cfg_h.axi4_slave_agent_cfg_h =
    axi4_slave_agent_config::type_id::create($sformatf("axi4_slave_agent_cfg_h[%0d]",i));
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.slave_id = i;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.min_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.
                                                           master_min_addr_range_array;
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.max_address = axi4_env_cfg_h.axi4_master_agent_cfg_h.
                                                           master_max_addr_range_array;
    if(SLAVE_AGENT_ACTIVE === 1) begin
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.is_active = uvm_active_passive_enum'(UVM_ACTIVE);
    end
    else begin
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.is_active = uvm_active_passive_enum'(UVM_PASSIVE);
    end 
    axi4_env_cfg_h.axi4_slave_agent_cfg_h.has_coverage = 1; 
    
    uvm_config_db #(axi4_slave_agent_config)::set(this,"*",$sformatf("axi4_slave_agent_config[%0d]",i), axi4_env_cfg_h.axi4_slave_agent_cfg_h);   
   `uvm_info(get_type_name(),$sformatf("\nx2h_SLAVE_CONFIG[%0d]\n%s",i,axi4_env_cfg_h.axi4_slave_agent_cfg_h.sprint()),UVM_LOW);
  end
