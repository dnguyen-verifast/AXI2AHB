...
package x2h_test_pkg;
  ...
  `include "x2h_blocking_64b_write_data_test.sv"
  `include "x2h_blocking_exokay_response_write_test.sv"
  ...
  `include "x2h_blocking_64b_data_read_test.sv"
  `include "x2h_blocking_64b_data_read_test.sv"
  `include "x2h_blocking_okay_response_read_test.sv"
  `include "x2h_blocking_exokay_response_read_test.sv"
  ...
  `include "x2h_blocking_64b_write_read_test.sv"
